...
export * from "https://deno.land/x/denops_std@v6.2.0/variable/mod.ts";
...
export * as datetime from "https://deno.land/std@0.218.0/datetime/mod.ts";
export * as vars from "https://deno.land/x/denops_std@v6.2.0/variable/mod.ts";
export * from "https://deno.land/x/denops_std@v6.2.0/batch/mod.ts";
